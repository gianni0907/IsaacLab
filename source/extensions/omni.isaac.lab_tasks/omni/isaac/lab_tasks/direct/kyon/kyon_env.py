...
class KyonEnv(DirectRLEnv):
    ...
    def _get_rewards(self) -> torch.Tensor:
        ...
        rewards = {
            "track_lin_vel_xy_exp": lin_vel_error_mapped * self.cfg.rew_scale_lin_vel * self.step_dt,
            "track_ang_vel_z_exp": yaw_rate_error_mapped * self.cfg.rew_scale_yaw_rate * self.step_dt,
            "lin_vel_z_l2": z_vel_error * self.cfg.rew_scale_z_vel * self.step_dt,
            "ang_vel_xy_l2": ang_vel_error * self.cfg.rew_scale_ang_vel * self.step_dt,
            "dof_torques_l2": joint_torques * self.cfg.rew_scale_joint_torque * self.step_dt,
            "dof_acc_l2": joint_accel * self.cfg.rew_scale_joint_acc * self.step_dt,
            "action_rate_l2": action_rate * self.cfg.rew_scale_action_rate * self.step_dt,
            "feet_air_time": air_time * self.cfg.rew_scale_feet_air_time * self.step_dt,
            "undesired_contacts": contacts * self.cfg.rew_scale_undesired_contact * self.step_dt,
            "flat_orientation_l2": flat_orientation * self.cfg.rew_scale_flat_orientation * self.step_dt,
        }
